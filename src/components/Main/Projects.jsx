...
const Projects = () => {
  return (
    ...
    <div id='projects' className='px-4 md:px-10 py-6 space-y-8'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-start gap-8 flex-wrap'>
            <Project 
            icon={<AiFillProject />}
            projectName="Bank Web App"
            txt="Modern Banking Landing Page"
            technology="ReactJs & Tailwindcss"
            size={"30664 KB"}
            color={"red"}
            link="https://github.com/EDOHWARES/Modern-Banking-Web-App"
            />

<Project 
            icon={<SiCodeproject />}
            projectName="Space Tourism"
            txt="Space Tourism Landing Page"
            technology="Javascript & Tailwindcss"
            size={"23564 KB"}
            color={"red"}
            link="https://github.com/EDOHWARES/SpaceTourism"
            />

<Project 
            icon={<RiProjectorFill />}
            projectName="Manage Page"
            txt="Manage Landing Page"
            technology="ReactJs & Tailwindcss"
            size={"1222 KB"}
            color={"green"}
            link="https://github.com/EDOHWARES/ManageLandingPage"
            />

<Project 
            icon={<SiCodeproject />}
            projectName="Travel Page"
            txt="Nigeria(9ja) Travel Website"
            technology="ReactJs & Vanilla CSS"
            size={"3002 KB"}
            color={"blue"}
            link="https://github.com/EDOHWARES/9ja-travel-page"
            />

<Project 
            icon={<AiFillProject />}
            projectName="Flyo Web App"
            txt="Flyo Landing Page"
            technology="ReactJs & Tailwindcss"
            size={"1250 KB"}
            color={"yellow"}
            link="https://github.com/EDOHWARES/flyo.org"
            />

<Project 
            icon={<RiProjectorFill />}
            projectName="Huddle Web App"
            txt="Huddle Landing Page"
            technology="ReactJs & Tailwindcss"
            size={"2033 KB"}
            link="https://github.com/EDOHWARES/huddle-landing-page"
            />
            
        </div>
    </div>
    <div className='text-center'>
        <a data-aos="fade-right" href="https://github.com/EDOHWARES" target='_blank'>
